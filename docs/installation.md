...
- **[The Samples App](samples-app.md)** - What you can do with the GUI
- **[Physical Sample Handling](physical-sample-handling.md)** - Workflow commands for metadata capture
