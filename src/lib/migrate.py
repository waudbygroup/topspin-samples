...
# set this to the path of the patch file (../schemas/current/patch.json, relative to this script)
_MIGRATIONS_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "schemas", "current", "patch.json")
